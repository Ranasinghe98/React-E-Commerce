...
export const Categories = () => {
    return (<>
        <div className='categories'>
            <div className='col'>
                <div className='row'>
                    <img src='https://images.pexels.com/photos/818992/pexels-photo-818992.jpeg?auto=compress&cs=tinysrgb&w=1600' alt='categories'/>
                    <button>
            ...
            <div className='col col-l'>
                <div className='row'>
                    ...
                    <div className='col'>
                        <div className='row'>
                            <img src='https://images.pexels.com/photos/2703202/pexels-photo-2703202.jpeg?auto=compress&cs=tinysrgb&w=1600' alt='categories'/>
                            <button>
                ...
                <div className='row'>
                    <img src='https://images.pexels.com/photos/1159670/pexels-photo-1159670.jpeg?auto=compress&cs=tinysrgb&w=1600' alt='categories'/>
                    <button>
